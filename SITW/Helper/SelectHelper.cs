...
namespace SITW.Helper
{
    public static class SelectHelper
    {
        ...
        public static MvcHtmlString TopicValidSelect(this HtmlHelper htmlhelper, string name, int? defualValue)//開放、靜態、的擴充方法
        {
            //List<cfgPlayGame> PlayGameList = new cfgPlayGameRepository().getAll();
            List<SelectListItem> sliList = new List<SelectListItem>();
            ...
            SelectListItem sli = new SelectListItem
            {
                Text = "不啟用",
                Value = "0",
                Selected = (0 == defualValue.Value ? true : false)
            };
            sliList.Add(sli);
            SelectListItem sli2 = new SelectListItem
            {
                Text = "啟用",
                Value = "1",
                Selected = (1 == defualValue.Value ? true : false)
            };
            sliList.Add(sli2);
