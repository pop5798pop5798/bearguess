...
TEXT_SELECT_LEVEL = "關卡A";
TEXT_COMPLETE = "完成";
TEXT_CONGRATULATIONS = "做得好，全部關卡完美通關!";
TEXT_HELP_PAGE_1_PC = "使用滑鼠移動發射器接住彈力球 在不掉落情況下摧毀所有磚塊。 任何掉落的物品有可能幫助你 得到更多分數";
TEXT_HELP_PAGE_1_MOBILE = "左右滑動讓發射器接住彈力球 在不掉落情況下摧毀所有磚塊。 任何掉落的物品有可能幫助你 得到更多分數!";
TEXT_DEVELOPED = "第一關過關 1010魚骨 之後四關每過一關+60魚骨";
TEXT_CONTENT = "超過1600分 +50魚骨 超過2200分 +75魚骨 超過3000分 +125魚骨";
...
var TEXT_ERR_LS = "您的網絡瀏覽器不支持本地存儲設置。在SAFARI，最常見的原因是使用“私人瀏覽模式”。某些信息可能無法保存或某些功能可能無法正常工作";
