...
function buildGameCanvas(){
	...
	for(var n=1; n<score_arr.length+extraBall;n++){
		...
		$.prize['score'+n].font = "25px quantifybold";
    ...
    payTitleTxt = new createjs.Text();
    payTitleTxt.font = "25px quantifybold";
    payTitleTxt.color = "#fff";
    payTitleTxt.textAlign = "center";
    payTitleTxt.textBaseline = 'alphabetic';
    payTitleTxt.text = 'Loading';
    payTitleTxt.x = canvasW /2 - 240;
    payTitleTxt.y = canvasH / 100 * 28;
