function CMain(oData){
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("coin_but", "./sprites/but_coin_bg.png?v=20190905");
        s_oSpriteLibrary.addSprite("coin_but_right", "./sprites/but_coin_bg_right.png?v=20190905");
        s_oSpriteLibrary.addSprite("coin_but_left", "./sprites/but_coin_bg_left.png?v=20190905");
        ...
        s_oSpriteLibrary.addSprite("but_lines_bg", "./sprites/but_coin_bg.png?v=20190905");
        s_oSpriteLibrary.addSprite("but_lines_bg_right", "./sprites/but_coin_bg_right.png?v=20190905");
        s_oSpriteLibrary.addSprite("but_lines_bg_left", "./sprites/but_coin_bg_left.png?v=20190905");
