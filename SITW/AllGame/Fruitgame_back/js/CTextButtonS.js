function CTextButtonS(iXPos, iYPos, oSprite, szText, szFont, szColor, iFontSize, oContainer) {
    var _bDisable;
    var _aParams;
    var _aCbCompleted;
    var _aCbOwner;
    ...
    this._init = function (iXPos, iYPos, oSprite, szText, szFont, szColor, iFontSize) {
        ...
        _oText2 = new createjs.Text("長按為自動旋轉", "16px " + szFont, szColor);
        _oText2.textAlign = "center";
        _oText2.textBaseline = "middle";

        _oText2.x = oSprite.width / 2;
        _oText2.y = Math.floor((oSprite.height) / 2) + 15;
        ...
        _oButton.addChild(oButtonBg, _oText, _oText2);
