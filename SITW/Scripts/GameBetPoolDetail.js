                 ...
                 <table>\
                    ...
                    <tbody style="color: #fff;">\
                        ...
                        <tr>\
                            <td>6</td>\
                            <td>X</td>\
                            <td>'+ value.poolall * 50 / 100 +'</td>\
                        </tr>\
                        <tr>\
                            <td>6</td>\
                            <td>O</td>\
                            <td>'+ value.poolall * 60 / 100 +'</td>\
                        </tr>\
                        <tr>\
                            <td colspan="3">\
...
function TopicHtmlGenerator(value)
{
        ...
        <div id="internal"> \
                    ...
                    <div class="card-body"> \
                        <div class="donbetin"> \
                            \
    <div class="dgon_from">\
        <div class="dgon-list" id="bettitle">\
    <span style="font-size:19px;color:#ffdc11;margin-bottom:10px;margin-top:20px">填空單</span>\
    <div class="fromnumber"><div style="float:left;color:#fff;margin-right:10px;">勝隊擊殺：</div>火龍 * <span id="fire_dnnumber">0</span>地龍 * <span id="ground_dnnumber">0</span>風龍 * <span id="wind_dnnumber">0</span>水龍 * <span id="water_dnnumber">0</span>大龍 * <span id="big_dnnumber">0</span></div>\
        ...
        <div class="dgon-list" id="betman" style="justify-content: center;">\
            <div class="dgon"> \
        ...
        <div class="dgon">\
                                <div class="dgon__portrait imageWrapper" id="bet05" name="betnumber">\
                                    <div class="dgon-box"><span>X</span></div >\
                                    <img class="dgonimg Tile-image" src="/Content/extra-images/dgon/dgon_null.png" alt="li-li">\
                                            </div>\
        </div>\
...
function submitbet(value) {
    ...
    margin-bottom: 0px;\
">\
                    <span style="color: #d5d5d5;">填空單確認框</span>\
                </div>\
...
"> * 100 = <span id="bet_m"></span> 魚骨幣\
        ...
        <div id="bet_combination">\
                <div style="float:left" class="Container-gon"><a style="float:left" id="betButtonClose" class="Btn Btn--primary Btn--purple Btn--shadow Btn--wide" href="#"><span class="Btn-inner"><span class="Btn-innerContent">返回重選\
                     ...
                     <div style="float:left" class="Container-gon"><a style="float:left" id="betButton" class="Btn Btn--primary Btn--purple Btn--shadow Btn--wide" href="#"><span class="Btn-inner"><span class="Btn-innerContent">確認預測                  \
     </span></span></a></div>\
               </div>   \
               </div>\
    </div>\
...
function createTopic(topicData) {
    ...
    $("#betlimit").on("click", function () {
        ...
        if (dgnai != 0) {
            myAlert('填空單錯誤', '填空單空格請填滿，不再增加的選項請用無擊殺取代！'); 
...
function dgonRate(ratemoney,poolall) {
    ...
    switch (vm) {
        ...
        case 5:
            ...
            break;
        case 6:
            if (parseInt($("input[name='betList[6].count']").val()) > 0) {
                bouns = 60;
            } else {
                bouns = 50;
            }
...
function choicedn(topicData) {
    ...
    for (var i = 0; i < dn.length; i++) {
        $(document).on('click', dn[i], function (event) {
            ...
            } else if (countbetall < 6 && thisid == "nix") {               
                var dgnai = 0;
                for (nixj = 0; nixj < 6; nixj++) {
                    dgnbet = $("#bet0" + nixj).find("img").attr("src");
                    if (dgnbet == "/Content/extra-images/dgon/dgon_null.png") {
