function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        _oMaxBetBut = new CTextButton(805 + (oSprite.width / 2), 575, oSprite, TEXT_MAX_BET, FONT_GAME, "#ffffff", 24, s_oStage);       
        _oMaxBetBut.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);

        oSprite = s_oSpriteLibrary.getSprite('but_maxbet_bg');
        _oMinBetBut = new CTextButton(805 + (oSprite.width / 2), 575 + 45, oSprite, TEXT_MIN_BET, FONT_GAME, "#ffffff", 24, s_oStage);
