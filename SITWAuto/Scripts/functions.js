jQuery(document).ready(function ($) {
    ...
    jQuery(window).scroll(function () {
        ...
        var wdth = $(window).width();              
                        ...
                        if (jQuery(this).scrollTop() > thisTop && wdth >= 750) {
                            ...
                            /*$("#sportsmagazine-header").css("transform", "translate3d(0px, 0px, 0px)");*/
   ...
   /* jQuery(window).resize(function () {
        ...
        if (width < 980)
        {
            $('#sportsmagazine-header').removeAttr("style");
    ...
    var boxlist;
     ...
     // jQuery('html').click( function() { jQuery(".sportsmagazine-cart-box").fadeOut(); });
    jQuery('a.sportsmagazine-open-cart').on("click", function () {
       jQuery('.sportsmagazine-cart-box2').slideToggle('slow');
        return false;
    });
    var boxlist;
    jQuery(".sportsmagazine-cart-box2").on("click", function () {
        boxlist = 0;
    });
    ...
    jQuery('html').on("click", function () {      
        if (boxlist !== 0)
        {
            jQuery(".sportsmagazine-cart-box2").fadeOut();
    ...
    jQuery('#image-button').on("click", function () {
        jQuery('#image-box').slideToggle('slow');
        return false;
    });
    var boxlist;
    jQuery("#image-box").on("click", function () {
        boxlist = 0;
    });
    ...
    jQuery('#league_create').on("click", function () {
        jQuery('#league_box').slideToggle('slow');
        return false;
    });
    var boxlist;
    jQuery("#league_box").on("click", function () {
        boxlist = 0;
    });
    ...
    $("div[name=imageList]>ul>li").click(function () {
    ...
    //任務note
    $('form[name=formMissionFinsh]').ajaxForm({
        success: function (res, status, xhr, form) {
            if (status == "success") {
                $(form).parents("li[name=imgview]").find("[name=iCheckMission]").show(500);
                $(form).parents("li[name=imgview]").delay(3000).fadeOut();
                updateAll()
            }
        }
    });

    $("span[name=MissionFinsh]").on("click", function () {
        $(this).parents("form").submit();
    });

    $("#buttonclose").on("click", function () {
        $(".sportsmagazine-cart-box2").fadeOut();
    });
    ...
    //把任務數設定到menu上
    $("#spanMissionNumber").html($("#MissionNumber").val());
    $("#spanMissionFinshNumber").html($("#MissionFinshNumber").val());
