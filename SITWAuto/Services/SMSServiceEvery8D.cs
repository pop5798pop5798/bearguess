...
{
    public class SMSServiceEvery8D
    {
        ...
        private string Account = System.Web.Configuration.WebConfigurationManager.AppSettings["Every8DAccount"];
        private string password = System.Web.Configuration.WebConfigurationManager.AppSettings["Every8DPWD"];


        public SMSServiceEvery8D()
        {
        }
        ...
        public bool sendSMS(string subject, string content, string mobile, string sendTime, string UserId)
        {
            bool success = false;
            try
            {
                ...
                postDataSb.Append("UID=").Append(Account);
                ...
                if (!resultString.StartsWith("-"))
                {
                    ...
                    new SMSRecordRepository().add(UserId, mobile, content);
                    success = true;
                }
                else
                {
